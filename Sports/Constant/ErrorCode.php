...
class ErrorCode
{
     ...
     */
    const STATUS_ROUTE_ERROR = 404;//路由错误
    ...
    const STATUS_ERROR_LOGIC = 970; //逻辑处理异常
    const STATUS_ERROR_LOGIC_ITEM_NOT_EXISTED = 971; //获取的Item不存在
    const STATUS_ERROR_LOGIC_NOT_SUPPORT = 972; //不支持
